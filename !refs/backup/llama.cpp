...
#include "llama.h" // Добавляем наш заголовок
...
struct VirtualDispatcher {
 ...
 void* (*load_block)(const char* block_key, void* user_data);
 void* user_data;
 ...
 cache[key] = block_data;
 }
 return reinterpret_cast<ggml_tensor*>(cache[key]);
 }
