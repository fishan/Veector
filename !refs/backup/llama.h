...
extern "C" {
    ...
    // Добавляем декларацию VirtualDispatcher и функции
    struct VirtualDispatcher; // Предварительное объявление структуры

    LLAMA_API void llama_set_virtual_dispatcher(struct VirtualDispatcher* dispatcher);
